...
import com.recall.memory.dto.MemoryStatusRequest;
...
public class MemoryController {
    ...
    public MemoryPageResponse list(
        ...
        return memoryService.list(q, type, cursor, limit, status);
    }
    ...
    public MemoryDetailResponse updateStatus(
            @PathVariable Long id, @Valid @RequestBody MemoryStatusRequest request) {
        return memoryService.updateStatus(id, request.status());
    }
}
