        ...
        AnswerContribution answer =
                new AnswerContribution() {
                    ...
                    public String render(MemoryCard card) {
                        return "요약:" + card.title();
                    }
                };
        CardCodec cardCodec = new CardCodec(List.of(new KnowledgeExtraction(new PromptLoader())));
        QueryPipeline pipeline = new QueryPipeline(search, cardCodec, List.of(answer));
